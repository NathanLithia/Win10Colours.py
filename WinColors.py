...
setting.Hilight="51 153 255"
setting.HilightText="255 255 255"
setting.HotTrackingColor="0 102 204"
...
setting.MenuHilight="51 153 255"
...
ButtonDkShadow=Button(windows, text="     ", bg="orange", fg="red")
...
GradientInactiveTitle=Button(windows, text="     ", bg="orange", fg="red")
...
InactiveBorder=Button(windows, text="     ", bg="orange", fg="red")
